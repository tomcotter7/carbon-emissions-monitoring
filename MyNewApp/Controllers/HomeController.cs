...
namespace MyNewApp.Controllers {
    public class HomeController : Controller {
        ...
        public async Task<IActionResult> Index(
            ...
            { Text = x.Name.DisplayName, Value = x.Name.QualifiedName }));
         ...
         * Date: 16/02/2021
         * 
         * About: Created new Task Dashboard to get it to load 
         *        Dashboard.cshtml on when the user clicks the tab.
         */
        ...
        )
        {
            ...
            // This needs to be a DashboardViewModel to handle the
            // Dashboard.cshtml file.
         ...
         * Date: 16/02/2021
         * 
         * About: Created this to get the asp-action to work when the user
         *        clicks the Insights tab at the top of the application
         *        page.
         */
        ...
        public async Task<IActionResult> AandP (
            [FromServices] IndustrialAppStoreHttpClient iasClient,
            CancellationToken cancellationToken = default)
        {
            var dataSources = await iasClient.DataSources.GetDataSourcesAsync(
            ...
            var viewModel = new AandPViewModel()
            {
                DataSources = selectItems
            };
            return View(viewModel);
        ...
        public async Task<IActionResult> FindTags (
            ...
            var tags = await iasClient.DataSources.FindTagsAsync(
                ...
                string.IsNullOrWhiteSpace(request.TagNameFilter) ? "*" : 
                request.TagNameFilter,
                page: request.Page,
                pageSize: pageSize,
